import { Lock, Radio, Sparkles, Terminal } from 'lucide-react';

export function TracksCartridge() {
  return (
    <div className="flex flex-col h-full justify-between items-center text-center gap-4 select-none p-3 sm:p-6" id="cartridge-tracks">
      {/* Header */}
      ...
      <div className="w-full max-w-xl p-6 sm:p-8 rounded-lg bg-[#141618] border-[3px] border-black shadow-[inset_3px_3px_0_0_#2b2e30,inset_-3px_-3px_0_0_#0a0b0c,4px_4px_0_0_rgba(0,0,0,0.7)] flex flex-col items-center justify-center my-auto space-y-4">
        <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#20252b] border-2 border-[#3d444d] flex items-center justify-center shadow-[0_0_16px_rgba(126,199,255,0.2)]">
          <Lock className="h-7 w-7 sm:h-8 sm:w-8 text-[#7ec7ff] animate-pulse" />
        </div>
